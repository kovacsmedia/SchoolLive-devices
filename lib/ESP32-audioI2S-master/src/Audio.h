...
#pragma once
///#ifndef AUDIO_GCC_OPTIMIZE
  // méretre optimalizálunk (a projektben úgyis -Os van)
//#define AUDIO_GCC_OPTIMIZE "Os"
//#endif
//#pragma GCC optimize (AUDIO_GCC_OPTIMIZE)
#include <vector>
#include <Arduino.h>
...
#ifndef AUDIO_ENABLE_TLS
  #define AUDIO_ENABLE_TLS 1
#endif
#if AUDIO_ENABLE_TLS
  #include <WiFiClientSecure.h>
#endif

// FS backends (size-opt: default OFF)
#ifndef AUDIO_ENABLE_SD
  #define AUDIO_ENABLE_SD 0
#endif
#ifndef AUDIO_ENABLE_SDMMC
  #define AUDIO_ENABLE_SDMMC 0
#endif
#ifndef AUDIO_ENABLE_SPIFFS
  #define AUDIO_ENABLE_SPIFFS 0
#endif
#ifndef AUDIO_ENABLE_FFAT
  #define AUDIO_ENABLE_FFAT 0
#endif
...
#include <FS.h>
  ...
  #include <SD.h>
#endif
#if AUDIO_ENABLE_SDMMC
  #include <SD_MMC.h>
#endif
#if AUDIO_ENABLE_SPIFFS
  #include <SPIFFS.h>
#endif
#if AUDIO_ENABLE_FFAT
  #include <FFat.h>
#endif
