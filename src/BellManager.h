...
enum class BellType : uint8_t { MAIN = 0, SIGNAL = 1 };
...
public:
    ...
    void requestSync() {
        ...
        Serial.println("[BELL] requestSync() – azonnali szinkron kérve");
    }
...
private:
    ...
    void   saveDefaultToNVS(const String& version, const BellEntry* entries, uint8_t count);
